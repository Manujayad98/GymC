...
public class TraineeViewScheduleJdbcRepository {
        ...
        public List<TraineeViewScheduleDetailsResponse> getTraineeSchedule(String traineeId) {
                ...
                List<TraineeViewScheduleDetailsResponse> traineeViewSchedule = jdbc.query(query1, namedParameters,
                                new BeanPropertyRowMapper<TraineeViewScheduleDetailsResponse>(
                                                TraineeViewScheduleDetailsResponse.class));
        ...
        public List<TraineeViewWorkoutDateResponse> getWorkoutDate(LocalDate traineeDate, Long traineeId) {
                ...
                List<TraineeViewWorkoutDateResponse> traineeWorkout = jdbc.query(query1, namedParameters,
                                new BeanPropertyRowMapper<TraineeViewWorkoutDateResponse>(
                                                TraineeViewWorkoutDateResponse.class));
        ...
        public DietPlan getDietDate(LocalDate traineeDate, Long traineeId) {
                ...
                DietPlan traineeDiet = (DietPlan) jdbcTemplate.queryForObject(query1, new Object[] { traineeDate },
                                new BeanPropertyRowMapper(DietPlan.class));

                // int count = jdbcTemplate.queryForObject(sql, new Object[] { nic },
                // Integer.class);
                return traineeDiet;
        }
        ...
        public TimeSlot getCalDate(LocalDate date1) {
                ...
                TimeSlot timeSlot = (TimeSlot) jdbcTemplate.queryForObject(query, new Object[] { date1 },
                                new BeanPropertyRowMapper(TimeSlot.class));
        ...
        public BodyFactorsResponse getBodyFactors(LocalDate date1, Long traineeId) {
                ...
                BodyFactorsResponse bodyFactors = (BodyFactorsResponse) jdbcTemplate.queryForObject(query,
                                new Object[] { date1 }, new BeanPropertyRowMapper(BodyFactorsResponse.class));
                return bodyFactors;
        }
        ...
        public List<TraineeProgressResponse> getTraineeProgress(Long traineeId) {
                ...
                List<TraineeProgressResponse> traineeProgressResponses = jdbc.query(query, namedParameters,
                                new BeanPropertyRowMapper<TraineeProgressResponse>(TraineeProgressResponse.class));
