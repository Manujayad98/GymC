  ...
  return (
    ...
    {/* <View style={styles.content}></View> */}
     <Icon name="backward" size={30} color="#fff" 
      ...
      <Text style={styles.heading1}>Place an<br/>Appoinment</Text>
      <Text style={styles.heading2}>Reserve time with a trainer for your<br/> first visit<br/><br/>Go to "Appoinments"<br/>to add one</Text>
