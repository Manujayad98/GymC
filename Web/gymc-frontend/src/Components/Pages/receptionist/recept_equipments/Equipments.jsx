...
import NewequipmentModal from '../../../Utilities/Popups/newequipmentModal';
import NewequipmentTypeModal from '../../../Utilities/Popups/newequiptype';
import Treadmill from '../../../../images/treadmill.png'
import Rowing from '../../../../images/rowingmachine.jpg'
...
const Equipments = () => {
  ...
  const [openNequipModal, setNequipModal] = useState(false)
  const [openequipType, setequipType] = useState(false)
        ...
        <div className="content-container">
          ...
          <div className='Ecard'>
            <Card className='rec-equipment-card'>
              <Card.Title>
                <img src={Treadmill} alt="" height={250} width={250} />
              </Card.Title>
