...
import { getTrainerData, addWorkoutDetails, addWorkoutDateExerciseDetails, addDietPlanDetails, getAvailableSlots, getExerciseDetails, getAvailableTrainers } from "../../../../services/WorkoutService";
...
const AddWorkout = () => {
    ...
    const [traineerDetails, setTrainerDetails] = useState([]);
                                        ...
                                        <div className="form-row">
                                            ...
                                            {(requestData.workoutType == 1) ?
                                                ...
                                                >
                                                    ...
                                                    {Object.values(traineerDetails).map((trainer) => (
                                                        <option value={trainer.id} >T000{trainer.id} {trainer.name}</option>
                                                    ))}
                                        ...
                                        <div className="form-row">
                                            ...
                                            <div className="form-col2">
                                                <InputField
                                                    ...
                                                    label="End Date"
                                                    placeholder='Type'
                                                    minDate={dateToday && requestData.start_date}
                                                    validators={[
                                                        { check: Validators.required, message: 'This field is required' }
                                                    ]}
